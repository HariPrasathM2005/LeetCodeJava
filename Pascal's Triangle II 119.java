...
package com.techwebdocs.pascaltriangleii;
...
public class PascalTriangleII {
    ...
    public static void main(String[] args) {
        ...
        Display(res);
        List<Integer> Res=res.get(res.size()-1);
        Display2(Res);
    }
    public static void Display2(List<Integer> res)
    {
    ...
    public static void Display(List<List<Integer>> res)
    {
        for(int i=0;i<res.size();i++)
        {
